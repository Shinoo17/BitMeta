...
{?>
    ...
    <nav class="navbar navbar-expand navbar-light" style="background-color: #0d154e; z-index: 9;" id="nav">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-white" href="select.php"><i class="bi bi-file-earmark-text"></i> Announcement</a>  
            <a class="navbar-brand text-white" href="login.php"><i class="bi bi-box-arrow-in-right"></i> login</a>
...
<?php }else { ?>
    ...
    <nav class="navbar navbar-expand navbar-light" style="background-color: #0d154e; z-index: 9; padding-left: 50px" id="nav">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="index.php"><i class="bi bi-house-fill"></i> Home</a>
            <a class="navbar-brand text-white" href="market.php"><i class="bi bi-currency-exchange"></i> Market</a>
            <a class="navbar-brand text-white" href="BuySellCrypto.php"><i class="bi bi-currency-exchange"></i> USDT Exchange</a>
            <a class="navbar-brand text-white" href="select.php"><i class="bi bi-file-earmark-text"></i> Announcement</a>
            <div id="indicator"></div>
        </div>
        <ul class="navbar-nav">
            <div class="dropdown">
                <div class="btn dropdown-toggle btn-sm m-1" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">

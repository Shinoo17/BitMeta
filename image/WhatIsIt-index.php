        ...
        <div class="container" style="margin-top: 20px;">              
            <div class="card-group">           
                <div class="card m-lg-2 ">                                                                 
                        <img src="image/WhatIsIt/Crypto.png" class="img-fluid" style="width:650px ; height:300px ;">                                         
                </div>    
                <div class="card m-lg-2 ">
                    <div class="card-body bg-dark" style="margin-left: auto;">                              
                        ...
                        <a href="https://www.thairath.co.th/lifestyle/money/2121706" class="btn btn-success text-white">อ่านเพิ่มเติม</a>
                    </div>
                </div>         
            </div>
        </div><br>
            ...
            <div class="container" style="margin-top: 20px;">              
                <div class="card-group">           
                    ...
                    <div class="card m-lg-2">
                     ...
                     <div class="card m-lg-2">                                                                 
                            <img src="image/WhatIsIt/bitcoin.jpg" class="img-fluid" style="width:650px ; height:300px ;">                                         
                    </div>          
                </div>
            </div><br>
            <div>
                <div class="container" style="margin-top: 20px;">              
                    <div class="card-group">           
                        <div class="card m-lg-2">                                                                 
                                <img src="image/WhatIsIt/eth.png" class="img-fluid" style="width:650px ; height:300px ;">                                         
                        </div>    
                        <div class="card m-lg-2">
                            <div class="card-body bg-dark" style="margin-left: auto;">                              
                                ...
                                <a href="https://moneyandbanking.co.th/article/the-guru/ethereum-cryptocurrency-mb472-aug2021-230864" class="btn btn-success">อ่านเพิ่มเติม</a>
                            </div>
                        </div>         
                    </div>
                </div><br><br>
